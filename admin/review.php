...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Přidání recenze</h1>
      </div>
      ...
      <form method="POST" class="add-review md-form" style="color: #757575;">
        <div class="text-center">
         ...
         <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="aktualnost" id="aktualnost1" value="1">
          <label class="form-check-label" for="aktualnost1">1</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="aktualnost" id="aktualnost2" value="2">
          <label class="form-check-label" for="aktualnost2">2</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="aktualnost" id="aktualnost3" value="3">
          <label class="form-check-label" for="aktualnost3">3</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="aktualnost" id="aktualnost4" value="4">
          <label class="form-check-label" for="aktualnost4">4</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="aktualnost" id="aktualnost5" value="5">
      ...
      <div class="text-center">
        ...
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="originalita" id="originalita1" value="1">
          <label class="form-check-label" for="originalita1">1</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="originalita" id="originalita2" value="2">
          <label class="form-check-label" for="originalita2">2</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="originalita" id="originalita3" value="3">
          <label class="form-check-label" for="originalita3">3</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="originalita" id="originalita4" value="4">
          <label class="form-check-label" for="originalita4">4</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="originalita" id="originalita5" value="5">
      ...
      <div class="text-center">
        ...
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="odbornost" id="odbornost1" value="1">
          <label class="form-check-label" for="odbornost1">1</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="odbornost" id="odbornost2" value="2">
          <label class="form-check-label" for="odbornost2">2</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="odbornost" id="odbornost3" value="3">
          <label class="form-check-label" for="odbornost3">3</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="odbornost" id="odbornost4" value="4">
          <label class="form-check-label" for="odbornost4">4</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="odbornost" id="odbornost5" value="5">
      ...
      <div class="text-center">
        ...
        <fieldset id="jazyk">
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="jazyk" id="jazyk1" value="1">
          <label class="form-check-label" for="jazyk1">1</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="jazyk" id="jazyk2" value="2">
          <label class="form-check-label" for="jazyk2">2</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="jazyk" id="jazyk3" value="3">
          <label class="form-check-label" for="jazyk3">3</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="jazyk" id="jazyk4" value="4">
          <label class="form-check-label" for="jazyk4">4</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="jazyk" id="jazyk5" value="5">
      ...
      <div class="float-left p-3">
        ...
        <textarea name="textComment" class="rounded-0 form-control"></textarea>
      </div>
      <div class="file-path-wrapper m-2 p-2 text-center">
          <input class="file-path validate btn btn-success rounded-0" type="submit" name="submit" value="Nahrát článek">
      </div>
      </div>
      </form>
      </div>
