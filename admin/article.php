...
?>
      ...
      <div class="container">
      <div class="d-flex justify-content-center p-3 article-wrap m-auto">
      ...
      <div class="file-path-wrapper m-2 p-2 text-center">
          <input class="file-path validate btn btn-primary rounded-0" type="submit" value="Nahrát článek">
      </div>
      </div>
      </div>
      </div>
